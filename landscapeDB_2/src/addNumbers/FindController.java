...
/*
 * Controller for FindWindow.fxml
 */
...
/*
 * Creates a table based on a general customer search
 ...
 */
	...
	public void getInfo(ActionEvent event) {
		 ...
		 loader.setLocation(getClass().getResource("/addNumbers/AddPhoneNumber.fxml"));
		 try {
			loader.load();
		} catch (IOException e) {
		}
		AddPhoneNumberController adding = loader.getController();
