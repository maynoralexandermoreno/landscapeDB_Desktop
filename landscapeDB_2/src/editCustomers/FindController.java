/*
 *	Unused Class; Controller for Find Window of this package;
 */
...
//
//import editCustomers.EditCustomerController;
...
//			loader.setLocation(getClass().getResource("/editCustomers/EditCustomers.fxml"));
//			loader.load();
//			EditCustomerController adding = loader.getController();
//			adding.c.setCustomer_id(c.getCustomer_id());
//			adding.c.setFirst_name(c.getFirst_name());
//			adding.c.setLast_name(c.getLast_name());			
//			primaryStage.close();			
//		} catch(Exception e){
//			
//		}
//		try {
//			Parent root;
//			root = FXMLLoader.load(getClass().getResource("/editCustomers/EditCustomers.fxml"));
//			Scene scene = new Scene(root);
//			Stage newStage = new Stage();
//			newStage.setScene(scene);
//			newStage.setTitle("Edit Customer Name");
